    ...
    <div class="login-card-container">
        <div class="login-card">
            ...
            <div class="login-card-header">
                ...
                <div>Zarejestruj się, aby korzystać z platformy!</div>
            </div>
            <form class="login-card-form">
                ...
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded">lock</span>
                    <input type="password" name="passwordRepeat" placeholder="Powtórz hasło" id="passwordRepeatInput" required>
                </div>
                ...
                <input type="submit" class="log" value="Zarejestruj">
            </form>
